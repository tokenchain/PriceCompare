...
public class CreateCaptchaImg {
    ...
    private void creatImage() {
        ...
        Font font = new Font("Antique Olive Compact", Font.PLAIN, fontHeight);
        g.setFont(font);
    ...
    private String randomStr(int n) {
        String str1 = "ABCDEFGHJKLMNOPQRSTUVWXYZabcdefghijkmnpqrstuvwxyz23456789";
        String str2 = "";
